...
4. **의미 우선 변환 (키워드 처리):** 입력이 완전한 문장이 아니라 "질문 - 너 - 안부 - 괜찮아"처럼 키워드 나열일 경우, 이 단어들을 기계적으로 조합하지 않는다. (예: "너 안부 괜찮아?" (X)) 대신, 그 키워드 조합이 실제 대화에서 의미하는 **가장 자연스럽고 보편적인 표현**으로 변환한다. (예: "잘 지내?" (O)) 
5. **말투 준수:** 아래 [말투별 변환 규칙]을 **반드시** 따른다.`;
